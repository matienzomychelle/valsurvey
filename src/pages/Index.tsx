      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <Card className="relative border-primary/20 hover:shadow-lg transition-all hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-lg">Scan or Access the QR Code</CardTitle>
                <CardDescription className="mt-2">
                  Use your phone or device to open the survey link.
                </CardDescription>
              </CardHeader>
            </Card>

            <Card className="relative border-primary/20 hover:shadow-lg transition-all hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
              <CardHeader className="text-center">
                <div className="relative inline-block mb-4">
                  <div className="w-20 h-20 mx-auto bg-muted rounded-2xl flex items-center justify-center">
                ...
                <CardTitle className="text-lg">Answer the Questions</CardTitle>
                <CardDescription className="mt-2">
                  Complete the short ARTA-compliant feedback form.
                </CardDescription>
              </CardHeader>
            </Card>

            <Card className="relative border-primary/20 hover:shadow-lg transition-all hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
              <CardHeader className="text-center">
                <div className="relative inline-block mb-4">
                  <div className="w-20 h-20 mx-auto bg-muted rounded-2xl flex items-center justify-center">
                ...
                <CardDescription className="mt-2">
                  Your feedback is securely recorded and assigned a reference ID.
                </CardDescription>
              </CardHeader>
            </Card>

            <Card className="relative border-primary/20 hover:shadow-lg transition-all hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
              <CardHeader className="text-center">
                <div className="relative inline-block mb-4">
                  <div className="w-20 h-20 mx-auto bg-muted rounded-2xl flex items-center justify-center">
                ...
                <CardTitle className="text-lg">Help Improve Services</CardTitle>
                <CardDescription className="mt-2">
                  Data is analyzed by the City Government to improve service quality.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
